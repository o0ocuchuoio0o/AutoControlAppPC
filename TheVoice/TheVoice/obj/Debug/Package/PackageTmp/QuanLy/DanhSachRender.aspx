<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DanhSachRender.aspx.cs" Inherits="TheVoice.QuanLy.DanhSachRender" %>
               ...
               <TopBar>
                   <ext:Toolbar ID="Toolbar1" runat="server">
                         ...
                         <ext:Button ID="btnhienthi" runat="server" Icon="ApplicationGo" IconAlign="Left" LabelStyle="color:Red;"
                          ...
                          <ext:Button ID="btndondepdulieu" runat="server" Icon="ApplicationDelete" IconAlign="Left" LabelStyle="color:Red;"
                               Text="Xóa file zip" Width="150" >
                                        <DirectEvents>
                                                    <Click OnEvent="btndondepdulieu_Click">
                                                        <EventMask Msg="..." ShowMask="true" />                                                       
                                                    </Click>
                                        </DirectEvents>
                          </ext:Button>
