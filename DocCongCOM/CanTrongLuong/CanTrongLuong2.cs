...
namespace CanTrongLuong
{
    class CanTrongLuong2
    {
        ...
        public CanTrongLuong2(string TenCong, int baudrate, Parity parity, StopBits stopbits, int databits)
        {
        ...
        public CanTrongLuong2(string TenCong)
        {
            this._TenCong = TenCong;
            _BaudRate = 9600;
            _Parity = Parity.None;
