<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="KiemSoatCuoiNgay.Default" %>
<%@ Register Assembly="Ext.Net" Namespace="Ext.Net" TagPrefix="ext" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
     <title>Hệ thống kiểm soát lỗi BCCP</title>    
            ...
            <ext:Panel ID="Panel1" 
				...
				<Content>
					<div id="titlebar">
						<div id="left">
							<div class="minor"></div>
							<div class="title">Hệ thống kiểm soát lỗi BCCP</div>							
						</div>
					</div>
				</Content>    
			</ext:Panel>
